...
class AuthorizationResponse: NSObject  {
     ...
     */
    private(set) var request: AuthorisationRequest?
...
//
    ...
    // MARK: - Initializers
    init(request: AuthorisationRequest?, parameters: [String : NSObject]?) {
        super.init()
...
//        request = try container.decode(AuthorisationRequest.self, forKey: .request)
